...
ns_section ns/server/${server}/module/revproxy {
	...
	#Index page of Solid
        ns_register_filter postauth GET  /solid/* ::revproxy::upstream -target https://localhost:8443/ -regsubs {{/solid/ ""}}
        ns_register_filter postauth POST /solid/* ::revproxy::upstream -target https://localhost:8443/ -regsubs {{/solid/ ""}}
	#Inbox
	ns_register_filter postauth GET  /inbox/ ::revproxy::upstream -target https://localhost:8443/inbox/ -regsubs {{/inbox/ ""}}
	
	#profile and settings
	ns_register_filter postauth GET  /profile/* ::revproxy::upstream -target https://localhost:8443
	ns_register_filter postauth GET  /settings/prefs.ttl ::revproxy::upstream -target https://localhost:8443

	#Login Popup window
	ns_register_filter postauth GET /.well-known/solid/login ::revproxy::upstream -target https://localhost:8443/.well-known/solid/login -regsubs {{/.well-known/solid/login ""}}
	ns_register_filter postauth GET /common/popup.html ::revproxy::upstream -target https://localhost:8443/common/popup.html -regsubs {{/common/popup.html ""}}


	#Requests for private page
	ns_register_filter postauth GET /private/* ::revproxy::upstream -target https://localhost:8443/
	ns_register_filter postauth PUT /private/* ::revproxy::upstream -target https://localhost:8443/
	ns_register_filter postauth PATCH /private/* ::revproxy::upstream -target https://localhost:8443/
	ns_register_filter postauth DELETE /private/* ::revproxy::upstream -target https://localhost:8443/
	
	#The requests for Public page
	ns_register_filter postauth GET /public/* ::revproxy::upstream -target https://localhost:8443
	ns_register_filter postauth PATCH /public/* ::revproxy::upstream -target https://localhost:8443
	ns_register_filter postauth PUT /public/* ::revproxy::upstream -target https://localhost:8443
	ns_register_filter postauth POST /public/* ::revproxy::upstream -target https://localhost:8443
	ns_register_filter postauth DELETE /public/* ::revproxy::upstream -target https://localhost:8443

 	#All the view elements and JS files required to process the requests
	ns_register_filter postauth GET  /common/* ::revproxy::upstream -target https://127.0.0.1:8443
	ns_register_filter postauth POST  /common/* ::revproxy::upstream -target https://127.0.0.1:8443


	


	#ns_register_filter postauth GET /* ::revproxy::upstream -target http://localhost:8000/
	#ns_register_filter postauth GET /* ::revproxy::upstream
#todo: if we have /solid/ substituted, keep it somewhere in memory and call next as /solid/example if called from within
